				...
				<td width="182" valign="top">
					<div id="container">
						...
						<div class="content">
							...
							<ul class="MM">
								<li>
									<a href="<%=path%>/admin/sysPro.jsp" target="main">系统参数</a>
								</li>
							</ul>
						</div>
						<h1 class="type">
						...
						<div class="content">
							...
							<ul class="MM">
								<li>
									<a href="<%=path %>/admin/admin/list.jsp" target="main">用户维护</a>
								</li>
						...
						<div class="content">
							...
							<ul class="MM">
								<li>
									<a href="<%=path %>/admin/user/list.jsp" target="main">会员信息维护</a>
								</li>
					...
					<div class="content">
						...
						<ul class="MM">
							<li>
								<a href="<%=path %>/admin/jiudian/list.jsp" target="main">酒店信息管理</a>
							</li>
						...
						<ul class="MM">
							<li>
								<a href="<%=path %>/admin/yuding/list.jsp" target="main">酒店预订管理</a>
							</li>
					...
					<div class="content">
						...
						<ul class="MM">
							...
							<li>
								<a href="<%=path %>/admin/news/list.jsp" target="main">新闻管理</a>
							</li>
					...
					<div class="content">
						...
						<ul class="MM">
							...
							<li>
								<a href="<%=path %>/admin/msg/list.jsp" target="main">留言管理</a>
							</li>
